...
export class CompanyService {
  ...
  getCompanies(): Observable<Company[]> {
    return this.httpClient.get<Company[]>(this.apiUrl(PATH));
  }
  addCompany(company: Company): Observable<any> {
    return this.httpClient.post<any>(this.apiUrl(PATH), this.toCompanyRequest(company), this.contentType);
  }

  deleteCompany(id: number): Observable<any> {
    return this.httpClient.delete<any>(this.apiUrl(PATH, id));
  }

  editCompany(company: Company): Observable<any> {
    return this.httpClient.put<Company>(this.apiUrl(PATH, company.id), this.toCompanyRequest(company), this.contentType);
  }
